...
public class FithubSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/", "/product/**", "/*/login", "/logout","/userTaskSuccess","/viewProducts/**","/userSave","/home","/shoppingCart/**","/constructUrlForProductOperations/**","/searchProduct/**","/contactUs").permitAll()
