...
-- -----------------------------------------------------
-- Table `fithub`.`shipping_address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fithub`.`shipping_address` ;

CREATE TABLE IF NOT EXISTS `fithub`.`shipping_address` (
...
CREATE TABLE IF NOT EXISTS `fithub`.`sales_order` (
  ...
  `status` ENUM('ACTIVE','COMPLETED','CANCELED') NULL DEFAULT 'ACTIVE' COMMENT '',
  ...
  CONSTRAINT `SalesOrderShippingAddress`
    ...
    REFERENCES `fithub`.`shipping_address` (`shipping_address_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `fithub`.`sales_order_item`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fithub`.`sales_order_item` ;

CREATE TABLE IF NOT EXISTS `fithub`.`sales_order_item` (
